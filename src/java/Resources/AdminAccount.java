...
public class AdminAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("npw")!=null&&request.getSession().getAttribute("username")!=null){
                ...
                if(l!=null&&l.getUser().getUsertype().getTypeName().equals("Admin")){
                        l.setPassword(request.getParameter("npw"));
                        s.update(l);
                        s.flush();
